...
## 🧪 [Unreleased] — _Royal 3D Runner Prototypes_ 👾👑

**תאריך לועזי:** 22 באוקטובר 2025  
**תאריך עברי:** י״ט בתשרי תשפ״ו  
**סטטוס:** 🔧 Work in Progress

### ✨ Added — תוספות

- ✅ **Royal_3D_Runner** — תיקייה חדשה ב-`04_Website/` עם משחק ראנר תלת-ממדי בדפדפן.
  - גרסאות בסיס v1, v2, v3 עם שליטה במקלדת, איסוף כתרים ויכולת Charge.
  - קבצי אסטרטגיה: Design Brief, Gameplay Strategy, Version Plan.
  - ממשק HUD מלכותי, אפקטי עומק ופרטים ויזואליים בהתאם לפלטת הצבעים.

### 🔧 Changed — שינויים

- 📝 עדכון תיעוד הגרסאות הראשוניות של המשחק והוראות ההפעלה.
